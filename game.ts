...
function getComputerMove(): RPS {
  return moves[Math.floor(Math.random() * moves.length)];
}

function determineWinner(player: RPS, computer: RPS): "win" | "lose" | "tie" {
...
function updateStats(result: "win" | "lose" | "tie") {
  if (result === "win") wins++;
...
function playRound(playerMove: RPS) {
